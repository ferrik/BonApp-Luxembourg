...
END $$;
DO $$ BEGIN
  ALTER TABLE partner_applications ADD COLUMN IF NOT EXISTS gallery_urls TEXT[];
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$ BEGIN
...
DO $$ BEGIN ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS logo_url     TEXT; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS gallery_urls TEXT[]; EXCEPTION WHEN OTHERS THEN NULL; END $$;
